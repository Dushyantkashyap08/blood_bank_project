<?php
	...
	if(isset($_POST['save']))
	{
		...
		{
			$query = "INSERT INTO requestform (name, age, mobile, email, bloodgroup, units) VALUES ('$name', '$age','$mobile', '$email', '$bgrp','$units')";
		}		
	...
	<body>
		...
		<div class="mid-section">
			...
			<div class="donor-content">
					...
					<marquee><p class="wbd">Welcome To Blood Request</p></marquee>
					...
					<div class="donorform">
						...
						<form class="rform" method="post">
							...
							<input type="text" value="<?php if(!empty($row['email'])) echo $row['email']?>" name="email" placeholder="Patient's Email" class="f" /><br>
